...
def function_imag_num(energy0,int_v,zp_nano):
    ...
    rta1 = EELS_film_num_f_div_gamma0(omegac0,epsi1,epsi2,hbmu,hbgama,int_v,b,zp)
...
def function_imag_pole_aprox(energy0,int_v,zp_nano):
    ...
    rta1 = EELS_film_pole_aprox_f_div_gamma0(omegac0,epsi1,epsi2,hbmu,hbgama,int_v,b,zp)
