...
def EELS_film_ana_f_div_gamma0(omegac,epsi1,epsi2,hbmu,hbgama,int_v,b,zp):     ## normalizando con el paper 149
    """    
    Parameters
    ----------
...
#    px_tot_2 = np.abs(px_v)**2 + np.abs(py_v)**2 + np.abs(pz_v)**2 
    rtaself_x1, rtaself_y1, rtaself_z1  =  green_self_ana_exponential_function(omegac,epsi1,epsi2,hbmu,hbgama,zp)
...
def EELS_film_num_f_div_gamma0(omegac,epsi1,epsi2,hbmu,hbgama,int_v,b,zp):     ## normalizando con el paper 149
    """    
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    
    ...
    px_v,py_v,pz_v = dipole_moment_num_for_decay_rate_resonance(omegac,epsi1,epsi2,hbmu,hbgama,int_v,b,zp) # multiplicar por e/(2*pi*v)
    

#    print(px_v,py_v,pz_v)
#    px_tot_2 = np.abs(px_v)**2 + np.abs(py_v)**2 + np.abs(pz_v)**2 
    rtaself_x1, rtaself_y1, rtaself_z1  =  green_self_num(omegac,epsi1,epsi2,hbmu,hbgama,zp)
    rtaself_x2, rtaself_y2, rtaself_z2  =  green_self_num_integral_inside_light_cone(omegac,epsi1,epsi2,hbmu,hbgama,zp)
...
def EELS_film_pole_aprox_f_div_gamma0(omegac,epsi1,epsi2,hbmu,hbgama,int_v,b,zp):     ## normalizando con el paper 149
    """    
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    
    ...
    con rp
    """
    px_v,py_v,pz_v = dipole_moment_pole_aprox_for_decay_rate_resonance(omegac,epsi1,epsi2,hbmu,hbgama,int_v,b,zp) # multiplicar por e/(2*pi*v)
    

#    print(px_v,py_v,pz_v)
#    px_tot_2 = np.abs(px_v)**2 + np.abs(py_v)**2 + np.abs(pz_v)**2 
    rtaself_x1, rtaself_y1, rtaself_z1  =  green_self_pole_aprox(omegac,epsi1,epsi2,hbmu,hbgama,zp)
    rtaself_x2, rtaself_y2, rtaself_z2  =  green_self_num_integral_inside_light_cone(omegac,epsi1,epsi2,hbmu,hbgama,zp)
