...
#    k1_2 = (k0*cte1)**2
 #   n_v1 = int_v/cte1
    ...
    rtaself_x, rtaself_y, rtaself_z  =  green_self_ana_exponential_function(omegac,epsi1,epsi2,hbmu,hbgama,zp)
...
def dipole_moment_num_resonance(omegac,epsi1,epsi2,hbmu,hbgama,int_v,b,zp):     
    """    
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    
...
def dipole_moment_num_for_decay_rate_resonance(omegac,epsi1,epsi2,hbmu,hbgama,int_v,b,zp):     
    """    
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    
...
def dipole_moment_pole_aprox_resonance(omegac,epsi1,epsi2,hbmu,hbgama,int_v,b,zp):     
    """    
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    
...
def dipole_moment_pole_aprox_for_decay_rate_resonance(omegac,epsi1,epsi2,hbmu,hbgama,int_v,b,zp):     
    """    
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    
