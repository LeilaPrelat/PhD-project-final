...
def dipole_moment_ana(omegac,epsi_silica,d_nano_film,d_thickness_disk_nano,D_disk_nano,int_v,b,zp):     ### usando 
    """    
    Parameters
    ----------
...
#    k1_2 = (k0*cte1)**2
 #   n_v1 = int_v/cte1
    ...
    rtaself_x, rtaself_y, rtaself_z  =  green_self_ana_exponential_function(omegac,epsi_silica,d_nano_film,zp)
...
def dipole_moment_ana_for_decay_rate(omegac,epsi_silica,d_nano_film,d_thickness_disk_nano,D_disk_nano,int_v,b,zp):     ### usando 
    """    
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    
...
def dipole_moment_num(omegac,epsi_silica,d_nano_film,d_thickness_disk_nano,D_disk_nano,int_v,b,zp):     
    """    
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    
...
def dipole_moment_num_for_decay_rate(omegac,epsi_silica,d_nano_film,d_thickness_disk_nano,D_disk_nano,int_v,b,zp):     
    """    
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    
...
#    k1_2 = (k0*cte1)**2
 #   n_v1 = int_v/cte1
    ...
    rtaself_x1, rtaself_y1, rtaself_z1  =  green_self_num(omegac,epsi_silica,d_nano_film,zp)
    rtaself_x2, rtaself_y2, rtaself_z2  =  green_self_num_integral_inside_light_cone(omegac,epsi_silica,d_nano_film,zp)
...
#     rp = lambda u: alpha_parallel(u)/(alpha_parallel(u) - alfa_p)
def dipole_moment_pole_aprox(omegac,epsi_silica,d_nano_film,d_thickness_disk_nano,D_disk_nano,int_v,b,zp):     
    """    
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    
...
#    k1_2 = (k0*cte1)**2
 #   n_v1 = int_v/cte1
    ...
    rtaself_x, rtaself_y, rtaself_z  =  green_self_pole_aprox(omegac,epsi_silica,d_nano_film,zp)
...
#     rp = lambda u: alpha_parallel(u)/(alpha_parallel(u) - alfa_p)
def dipole_moment_pole_aprox_for_decay_rate(omegac,epsi_silica,d_nano_film,d_thickness_disk_nano,D_disk_nano,int_v,b,zp):     
    """    
    Parameters
    ----------
    omegac : omega/c = k0 en 1/micrometros    
    ...
    rtaself_x1, rtaself_y1, rtaself_z1  =  green_self_pole_aprox(omegac,epsi_silica,d_nano_film,zp)
    rtaself_x2, rtaself_y2, rtaself_z2  =  green_self_num_integral_inside_light_cone(omegac,epsi_silica,d_nano_film,zp)
