...
path_save = path_basic + '/' + 'potential_ind'
...
try:
    ...
    from potential_induced import potential_ana_resonance_v1,potential_ana_resonance_v2, potential_num_resonance
