...
try:
    ...
    from dipole_moment import dipole_moment_pole_aprox_resonance_v1,dipole_moment_ana_resonance_v1,dipole_moment_anav1_for_decay_rate_resonance,dipole_moment_pole_aprox_resonance_v1_for_decay_rate,dipole_moment_ana_perfect_dipole_resonance
except ModuleNotFoundError:
...
#        
    rta = 2*epsi_silica(E)*(np.abs(phi_n)**2)*cte_formula*k_prima*(int_v**(-2))/(factor_K*seno_theta_n)        
