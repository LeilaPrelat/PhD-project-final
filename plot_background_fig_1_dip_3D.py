...
#%% 
N = 1e3
listx = np.linspace(-4900,4900,N)
listy = np.linspace(-5000,5000,N)
...
os.chdir(path_save)
plt.box(False)
plt.savefig( 'background_plane_1dip'  + '.png', format='png',bbox_inches='tight',pad_inches = 0,dpi = dpi, transparent=True)   
